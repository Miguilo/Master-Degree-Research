...
def main(cfg: DictConfig):
    ...
    all_train_score_df_path = get_absolute_path(
        cfg.eval.all.polar_apolar.train_score_path
    )
    all_test_score_df_path = get_absolute_path(
        cfg.eval.all.polar_apolar.test_score_path
    )
    all_train_std_df_path = get_absolute_path(
        cfg.eval.all.polar_apolar.train_std_path
    )
    all_test_std_df_path = get_absolute_path(
        cfg.eval.all.polar_apolar.test_std_path
    )
    ...
    partial_iso_train_score_df_path = get_absolute_path(
        cfg.eval.partial_iso.polar_apolar.train_score_path
    )
    partial_iso_test_score_df_path = get_absolute_path(
        cfg.eval.partial_iso.polar_apolar.test_score_path
    )
    partial_iso_train_std_df_path = get_absolute_path(
        cfg.eval.partial_iso.polar_apolar.train_std_path
    )
    partial_iso_test_std_df_path = get_absolute_path(
        cfg.eval.partial_iso.polar_apolar.test_std_path
    )
    ...
    partial_aniso_train_score_df_path = get_absolute_path(
        cfg.eval.partial_aniso.polar_apolar.train_score_path
    )
    partial_aniso_test_score_df_path = get_absolute_path(
        cfg.eval.partial_aniso.polar_apolar.test_score_path
    )
    partial_aniso_train_std_df_path = get_absolute_path(
        cfg.eval.partial_aniso.polar_apolar.train_std_path
    )
    partial_aniso_test_std_df_path = get_absolute_path(
        cfg.eval.partial_aniso.polar_apolar.test_std_path
    )
