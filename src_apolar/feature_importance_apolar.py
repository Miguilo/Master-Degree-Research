...
def main(cfg: DictConfig):
    ...
    path_partial_iso_mol_x0 = get_absolute_path(
        f"{cfg.models.apolar.all}/partial_iso_molecules_models.sav"
    )
    path_partial_iso_mol_x1 = get_absolute_path(
        f"{cfg.models.apolar.ei_alpha}/partial_iso_molecules_models.sav"
    )
    path_partial_iso_mol_x2 = get_absolute_path(
        f"{cfg.models.apolar.pi_ei}/partial_iso_molecules_models.sav"
    )
    path_partial_iso_mol_x3 = get_absolute_path(
        f"{cfg.models.apolar.pi_alpha}/partial_iso_molecules_models.sav"
    )
    ...
    path_partial_aniso_mol_x0 = get_absolute_path(
        f"{cfg.models.apolar.all}/partial_aniso_molecules_models.sav"
    )
    path_partial_aniso_mol_x1 = get_absolute_path(
        f"{cfg.models.apolar.ei_alpha}/partial_aniso_molecules_models.sav"
    )
    path_partial_aniso_mol_x2 = get_absolute_path(
        f"{cfg.models.apolar.pi_ei}/partial_aniso_molecules_models.sav"
    )
    path_partial_aniso_mol_x3 = get_absolute_path(
        f"{cfg.models.apolar.pi_alpha}/partial_aniso_molecules_models.sav"
    )
