...
from utils.optimization import convert_to_space, opt_all, modify_scaling, test_pred_nested_cv
...
def main(cfg: DictConfig):
    ...
    for i, j in enumerate(list_of_x_all):
        ...
        predictions = test_pred_nested_cv(new_list_of_models[0], list_of_spaces[0],
                                                  j, y_all, 10, 5)
